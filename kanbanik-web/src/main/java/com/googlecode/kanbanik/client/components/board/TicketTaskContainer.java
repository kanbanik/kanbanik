...
public class TicketTaskContainer extends Composite implements TaskContainer {
	...
	interface MyUiBinder extends UiBinder<FlowPanel, TicketTaskContainer> {
	}

	private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

	public TicketTaskContainer(Dtos.BoardDto board, final Dtos.WorkflowitemDto currentItem) {
		this.board = board;
	...
	@Override
	public HasVisibility add(TaskDto taskDto, BoardsFilter filter, DragController dragController) {
