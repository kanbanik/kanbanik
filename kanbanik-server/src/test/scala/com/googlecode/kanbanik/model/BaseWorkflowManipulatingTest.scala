...
class BaseWorkflowManipulatingTest extends FlatSpec with BeforeAndAfter with HasMongoConnection {
  ...
  val board = new Board(None, "", 1, workflow, List(), true, WorkfloVerticalSizing.BALANCED)
  ...
  val board1 = new Board(None, "", 1, workflow0, List(), true, WorkfloVerticalSizing.BALANCED)
